<template>
  <div :class="$style.root">
    ...
    <RouterLink :to="{ name: 'ReceptionistEdit' }">
...
import { selectItems, removeItem, fetchItems  } from '@/store/receptionists/selectors'
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      onClickEdit: ( id ) => {
        router.push({ name: 'ReceptionistEdit', params: { id } })
      }
    }
  },
}
